...
async def chat(request: RequestObject):
    ...
    def generate():
        for token, _ in agent.stream(
            {'messages': [
                SystemMessage("You are an AI-powered stock analysis assistant. "
                    "You can retrieve real-time stock prices, historical stock prices, "
                    "balance sheet data, company news, technical indicators, "
                    "and generate stock recommendations. "
                    "Use the available tools whenever financial data is required. "
                    "When analyzing stocks, consider price trends, news sentiment, "
                    "and financial data before making recommendations."
                ),
